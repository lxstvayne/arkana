...
func _() {
	...
	_ = x[TOKENTYPE_EOF-36]
}

const _TokenType_name = "NUMBERHEX_NUMBERNONEWORDTEXTIFELSEWHILEFORBREAKCONTINUEFUNCRETURNPLUSMINUSSTARSLASHEQEQEQEXCLEXCLEQLTLTEQGTGTEQBARBARBARAMPAMPAMPLPARRPARLBRACERBRACELBRACKETRBRACKETCOMMAEOF"

var _TokenType_index = [...]uint8{0, 6, 16, 20, 24, 28, 30, 34, 39, 42, 47, 55, 59, 65, 69, 74, 78, 83, 85, 89, 93, 99, 101, 105, 107, 111, 114, 120, 123, 129, 133, 137, 143, 149, 157, 165, 170, 173}
